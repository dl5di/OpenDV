...
CNetworkSet::CNetworkSet(wxWindow* parent, int id, const wxString& title, const wxString& gatewayAddress, unsigned int gatewayPort, const wxString& localAddress, unsigned int localPort) :
wxPanel(parent, id),
m_title(title),
...
CNetworkSet::~CNetworkSet()
{
}

bool CNetworkSet::Validate()
{
...
wxString CNetworkSet::getGatewayAddress() const
{
	return m_gatewayAddress->GetValue();
}

unsigned int CNetworkSet::getGatewayPort() const
{
	unsigned long n;
...
wxString CNetworkSet::getLocalAddress() const
{
	return m_localAddress->GetValue();
}

unsigned int CNetworkSet::getLocalPort() const
{
	unsigned long n;
