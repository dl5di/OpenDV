...
unsigned int CAMBEFEC::regenerate(bool* bits) const
{
	wxASSERT(bits != NULL);

	unsigned int a = (bits[7]  ? 0x800000 : 0x000000) |	(bits[1]  ? 0x400000 : 0x000000) |
					 (bits[11] ? 0x200000 : 0x000000) |	(bits[21] ? 0x100000 : 0x000000) |
					 (bits[31] ? 0x080000 : 0x000000) | (bits[25] ? 0x040000 : 0x000000) |
					 (bits[35] ? 0x020000 : 0x000000) | (bits[45] ? 0x010000 : 0x000000) |
					 (bits[55] ? 0x008000 : 0x000000) | (bits[49] ? 0x004000 : 0x000000) |
					 (bits[59] ? 0x002000 : 0x000000) | (bits[69] ? 0x001000 : 0x000000) |
					 (bits[6]  ? 0x000800 : 0x000000) | (bits[0]  ? 0x000400 : 0x000000) |
					 (bits[10] ? 0x000200 : 0x000000) | (bits[20] ? 0x000100 : 0x000000) |
					 (bits[30] ? 0x000080 : 0x000000) | (bits[24] ? 0x000040 : 0x000000) |
					 (bits[34] ? 0x000020 : 0x000000) | (bits[44] ? 0x000010 : 0x000000) |
					 (bits[54] ? 0x000008 : 0x000000) | (bits[48] ? 0x000004 : 0x000000) |
					 (bits[58] ? 0x000002 : 0x000000) | (bits[68] ? 0x000001 : 0x000000);

	unsigned int b = (bits[5]  ? 0x800000 : 0x000000) | (bits[15] ? 0x400000 : 0x000000) |
					 (bits[9]  ? 0x200000 : 0x000000) | (bits[19] ? 0x100000 : 0x000000) |
					 (bits[29] ? 0x080000 : 0x000000) | (bits[39] ? 0x040000 : 0x000000) |
					 (bits[33] ? 0x020000 : 0x000000) | (bits[43] ? 0x010000 : 0x000000) |
					 (bits[53] ? 0x008000 : 0x000000) | (bits[63] ? 0x004000 : 0x000000) |
					 (bits[57] ? 0x002000 : 0x000000) | (bits[67] ? 0x001000 : 0x000000) |
					 (bits[4]  ? 0x000800 : 0x000000) | (bits[14] ? 0x000400 : 0x000000) |
					 (bits[8]  ? 0x000200 : 0x000000) | (bits[18] ? 0x000100 : 0x000000) |
					 (bits[28] ? 0x000080 : 0x000000) | (bits[38] ? 0x000040 : 0x000000) |
					 (bits[32] ? 0x000020 : 0x000000) | (bits[42] ? 0x000010 : 0x000000) |
					 (bits[52] ? 0x000008 : 0x000000) | (bits[62] ? 0x000004 : 0x000000) |
					 (bits[56] ? 0x000002 : 0x000000) | (bits[66] ? 0x000001 : 0x000000);

	unsigned int c = (bits[3]  ? 0x800000 : 0x000000) | (bits[13] ? 0x400000 : 0x000000) |
					 (bits[23] ? 0x200000 : 0x000000) | (bits[17] ? 0x100000 : 0x000000) |
					 (bits[27] ? 0x080000 : 0x000000) | (bits[37] ? 0x040000 : 0x000000) |
					 (bits[47] ? 0x020000 : 0x000000) | (bits[41] ? 0x010000 : 0x000000) |
					 (bits[51] ? 0x008000 : 0x000000) | (bits[61] ? 0x004000 : 0x000000) |
					 (bits[71] ? 0x002000 : 0x000000) | (bits[65] ? 0x001000 : 0x000000) |
					 (bits[2]  ? 0x000800 : 0x000000) | (bits[12] ? 0x000400 : 0x000000) |
					 (bits[22] ? 0x000200 : 0x000000) | (bits[16] ? 0x000100 : 0x000000) |
					 (bits[26] ? 0x000080 : 0x000000) | (bits[36] ? 0x000040 : 0x000000) |
					 (bits[46] ? 0x000020 : 0x000000) | (bits[40] ? 0x000010 : 0x000000) |
					 (bits[50] ? 0x000008 : 0x000000) | (bits[60] ? 0x000004 : 0x000000) |
					 (bits[70] ? 0x000002 : 0x000000) | (bits[64] ? 0x000001 : 0x000000);

	unsigned int errors = regenerate(a, b, c);

	bits[7]  = (a & 0x800000) == 0x800000; bits[6]  = (a & 0x000800) == 0x000800;
	bits[5]  = (b & 0x800000) == 0x800000; bits[4]  = (b & 0x000800) == 0x000800;
	bits[3]  = (c & 0x800000) == 0x800000; bits[2]  = (c & 0x000800) == 0x000800;
	bits[1]  = (a & 0x400000) == 0x400000; bits[0]  = (a & 0x000400) == 0x000400;
	bits[15] = (b & 0x400000) == 0x400000; bits[14] = (b & 0x000400) == 0x000400;
	bits[13] = (c & 0x400000) == 0x400000; bits[12] = (c & 0x000400) == 0x000400;
	bits[11] = (a & 0x200000) == 0x200000; bits[10] = (a & 0x000200) == 0x000200;
	bits[9]  = (b & 0x200000) == 0x200000; bits[8]  = (b & 0x000200) == 0x000200;
	bits[23] = (c & 0x200000) == 0x200000; bits[22] = (c & 0x000200) == 0x000200;
	bits[21] = (a & 0x100000) == 0x100000; bits[20] = (a & 0x000100) == 0x000100;
	bits[19] = (b & 0x100000) == 0x100000; bits[18] = (b & 0x000100) == 0x000100;
	bits[17] = (c & 0x100000) == 0x100000; bits[16] = (c & 0x000100) == 0x000100;
	bits[31] = (a & 0x080000) == 0x080000; bits[30] = (a & 0x000080) == 0x000080;
	bits[29] = (b & 0x080000) == 0x080000; bits[28] = (b & 0x000080) == 0x000080;
	bits[27] = (c & 0x080000) == 0x080000; bits[26] = (c & 0x000080) == 0x000080;
	bits[25] = (a & 0x040000) == 0x040000; bits[24] = (a & 0x000040) == 0x000040;
	bits[39] = (b & 0x040000) == 0x040000; bits[38] = (b & 0x000040) == 0x000040;
	bits[37] = (c & 0x040000) == 0x040000; bits[36] = (c & 0x000040) == 0x000040;
	bits[35] = (a & 0x020000) == 0x020000; bits[34] = (a & 0x000020) == 0x000020;
	bits[33] = (b & 0x020000) == 0x020000; bits[32] = (b & 0x000020) == 0x000020;
	bits[47] = (c & 0x020000) == 0x020000; bits[46] = (c & 0x000020) == 0x000020;
	bits[45] = (a & 0x010000) == 0x010000; bits[44] = (a & 0x000010) == 0x000010;
	bits[43] = (b & 0x010000) == 0x010000; bits[42] = (b & 0x000010) == 0x000010;
	bits[41] = (c & 0x010000) == 0x010000; bits[40] = (c & 0x000010) == 0x000010;
	bits[55] = (a & 0x008000) == 0x008000; bits[54] = (a & 0x000008) == 0x000008;
	bits[53] = (b & 0x008000) == 0x008000; bits[52] = (b & 0x000008) == 0x000008;
	bits[51] = (c & 0x008000) == 0x008000; bits[50] = (c & 0x000008) == 0x000008;
	bits[49] = (a & 0x004000) == 0x004000; bits[48] = (a & 0x000004) == 0x000004;
	bits[63] = (b & 0x004000) == 0x004000; bits[62] = (b & 0x000004) == 0x000004;
	bits[61] = (c & 0x004000) == 0x004000; bits[60] = (c & 0x000004) == 0x000004;
	bits[59] = (a & 0x002000) == 0x002000; bits[58] = (a & 0x000002) == 0x000002;
	bits[57] = (b & 0x002000) == 0x002000; bits[56] = (b & 0x000002) == 0x000002;
	bits[71] = (c & 0x002000) == 0x002000; bits[70] = (c & 0x000002) == 0x000002;
	bits[69] = (a & 0x001000) == 0x001000; bits[68] = (a & 0x000001) == 0x000001;
	bits[67] = (b & 0x001000) == 0x001000; bits[66] = (b & 0x000001) == 0x000001;
	bits[65] = (c & 0x001000) == 0x001000; bits[64] = (c & 0x000001) == 0x000001;
