...
CAnnouncementSet::CAnnouncementSet(wxWindow* parent, int id, const wxString& title, bool enabled, unsigned int time, const wxString& recordRPT1, const wxString& recordRPT2, const wxString& deleteRPT1, const wxString& deleteRPT2) :
wxPanel(parent, id),
m_title(title),
m_enabled(NULL),
m_time(NULL),
...
CAnnouncementSet::~CAnnouncementSet()
{
}

bool CAnnouncementSet::Validate()
{
	return m_enabled->GetCurrentSelection() != wxNOT_FOUND;
}

bool CAnnouncementSet::getEnabled() const
{
...
unsigned int CAnnouncementSet::getTime() const
{
	return m_time->GetValue() * 60U;
}

wxString CAnnouncementSet::getRecordRPT1() const
{
	return m_recordRPT1->GetValue().MakeUpper();
}

wxString CAnnouncementSet::getRecordRPT2() const
{
	return m_recordRPT2->GetValue().MakeUpper();
}

wxString CAnnouncementSet::getDeleteRPT1() const
{
	return m_deleteRPT1->GetValue().MakeUpper();
}

wxString CAnnouncementSet::getDeleteRPT2() const
{
