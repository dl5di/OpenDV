...
class CNetworkSet : public wxPanel {
public:
	CNetworkSet(wxWindow* parent, int id, const wxString& title, const wxString& gatewayAddress, unsigned int gatewayPort, const wxString& localAddress, unsigned int localPort);
	virtual ~CNetworkSet();
