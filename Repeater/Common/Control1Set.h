...
#ifndef	Control1Set_H
#define	Control1Set_H

#include "CallsignTextCtrl.h"

#include <wx/wx.h>

class CControl1Set : public wxPanel {
public:
	CControl1Set(wxWindow* parent, int id, const wxString& title, bool enabled,
