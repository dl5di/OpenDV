...
#ifndef	AnnouncementSet_H
#define	AnnouncementSet_H
...
class CAnnouncementSet : public wxPanel {
public:
	CAnnouncementSet(wxWindow* parent, int id, const wxString& title, bool enabled, unsigned int time, const wxString& recordRPT1, const wxString& recordRPT2, const wxString& deleteRPT1, const wxString& deleteRPT2);
	virtual ~CAnnouncementSet();
