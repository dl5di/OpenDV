...
#ifndef	DVRPTRControllerV3_H
#define	DVRPTRControllerV3_H
...
class CDVRPTRControllerV3 : public IDVRPTRController, public wxThread {
public:
	CDVRPTRControllerV3(const wxString& port, const wxString& path, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign);
	CDVRPTRControllerV3(const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign);
	virtual ~CDVRPTRControllerV3();
