...
CControl1Set::~CControl1Set()
{
}

bool CControl1Set::Validate()
{
	return m_enabled->GetCurrentSelection() != wxNOT_FOUND;
}

bool CControl1Set::getEnabled() const
{
...
wxString CControl1Set::getRPT1Callsign() const
{
	return m_rpt1Callsign->GetValue().MakeUpper();
}

wxString CControl1Set::getRPT2Callsign() const
{
	return m_rpt2Callsign->GetValue().MakeUpper();
}

wxString CControl1Set::getShutdown() const
{
	return m_shutdown->GetValue().MakeUpper();
}

wxString CControl1Set::getStartup() const
{
	return m_startup->GetValue().MakeUpper();
}

wxString CControl1Set::getStatus1() const
{
	return m_status1->GetValue().MakeUpper();
}

wxString CControl1Set::getStatus2() const
{
	return m_status2->GetValue().MakeUpper();
}

wxString CControl1Set::getStatus3() const
{
	return m_status3->GetValue().MakeUpper();
}

wxString CControl1Set::getStatus4() const
{
	return m_status4->GetValue().MakeUpper();
}

wxString CControl1Set::getStatus5() const
{
	return m_status5->GetValue().MakeUpper();
}

wxString CControl1Set::getOutput1() const
{
	return m_output1->GetValue().MakeUpper();
}

wxString CControl1Set::getOutput2() const
{
	return m_output2->GetValue().MakeUpper();
}

wxString CControl1Set::getOutput3() const
{
	return m_output3->GetValue().MakeUpper();
}

wxString CControl1Set::getOutput4() const
{
