...
CBeaconSet::CBeaconSet(wxWindow* parent, int id, const wxString& title, unsigned int time, const wxString& text, bool voice, TEXT_LANG language) :
wxPanel(parent, id),
m_title(title),
m_time(NULL),
m_text(NULL),
...
CBeaconSet::~CBeaconSet()
{
}

bool CBeaconSet::Validate()
{
...
unsigned int CBeaconSet::getTime() const
{
	return m_time->GetValue() * 60U;
}

wxString CBeaconSet::getText() const
{
	return m_text->GetValue();
}

bool CBeaconSet::getVoice() const
{
...
TEXT_LANG CBeaconSet::getLanguage() const
{
