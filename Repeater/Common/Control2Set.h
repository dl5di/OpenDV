...
#ifndef	Control2Set_H
#define	Control2Set_H

#include "CallsignTextCtrl.h"

#include <wx/wx.h>

class CControl2Set : public wxPanel {
public:
	CControl2Set(wxWindow* parent, int id, const wxString& title, const wxString& command1,
