...
#ifndef	SplitRepeaterControl1Set_H
#define	SplitRepeaterControl1Set_H

#include "CallsignTextCtrl.h"

#include <wx/wx.h>

class CSplitRepeaterControl1Set : public wxPanel {
public:
	CSplitRepeaterControl1Set(wxWindow* parent, int id, const wxString& title, bool enabled,
	...
	virtual ~CSplitRepeaterControl1Set();
