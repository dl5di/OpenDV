...
#ifndef SplitRepeaterUDPReaderWriter_H
#define SplitRepeaterUDPReaderWriter_H
...
class CSplitRepeaterUDPReaderWriter {
public:
	CSplitRepeaterUDPReaderWriter(const wxString& address, unsigned int port);
	~CSplitRepeaterUDPReaderWriter();
