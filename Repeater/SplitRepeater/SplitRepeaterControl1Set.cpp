...
CSplitRepeaterControl1Set::CSplitRepeaterControl1Set(wxWindow* parent, int id, const wxString& title, bool enabled, const wxString& rpt1Callsign, const wxString& rpt2Callsign, const wxString& shutdown, const wxString& startup, const wxString& status1, const wxString& status2, const wxString& status3, const wxString& status4, const wxString& status5) :
wxPanel(parent, id),
m_title(title),
m_enabled(NULL),
m_rpt1Callsign(NULL),
...
CSplitRepeaterControl1Set::~CSplitRepeaterControl1Set()
{
}

bool CSplitRepeaterControl1Set::Validate()
{
	return m_enabled->GetCurrentSelection() != wxNOT_FOUND;
}

bool CSplitRepeaterControl1Set::getEnabled() const
{
...
wxString CSplitRepeaterControl1Set::getRPT1Callsign() const
{
	return m_rpt1Callsign->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getRPT2Callsign() const
{
	return m_rpt2Callsign->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getShutdown() const
{
	return m_shutdown->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStartup() const
{
	return m_startup->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStatus1() const
{
	return m_status1->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStatus2() const
{
	return m_status2->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStatus3() const
{
	return m_status3->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStatus4() const
{
	return m_status4->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl1Set::getStatus5() const
{
