...
bool CSplitRepeaterControl2Set::Validate()
{
	return true;
}

wxString CSplitRepeaterControl2Set::getCommand1() const
{
	return m_command1->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl2Set::getCommand1Line() const
{
	return m_command1Line->GetValue();
}

wxString CSplitRepeaterControl2Set::getCommand2() const
{
	return m_command2->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl2Set::getCommand2Line() const
{
	return m_command2Line->GetValue();
}

wxString CSplitRepeaterControl2Set::getCommand3() const
{
	return m_command3->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl2Set::getCommand3Line() const
{
	return m_command3Line->GetValue();
}

wxString CSplitRepeaterControl2Set::getCommand4() const
{
	return m_command4->GetValue().MakeUpper();
}

wxString CSplitRepeaterControl2Set::getCommand4Line() const
{
