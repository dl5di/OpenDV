...
#ifndef	SplitRepeaterControl2Set_H
#define	SplitRepeaterControl2Set_H

#include "CallsignTextCtrl.h"

#include <wx/wx.h>

class CSplitRepeaterControl2Set : public wxPanel {
public:
	CSplitRepeaterControl2Set(wxWindow* parent, int id, const wxString& title, const wxString& command1,
	...
	virtual ~CSplitRepeaterControl2Set();
