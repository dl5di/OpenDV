...
CDVRPTRRepeaterLogger::CDVRPTRRepeaterLogger() :
wxLog()
{
}
...
void CDVRPTRRepeaterLogger::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CDVRPTRRepeaterLogger::DoLogString(const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
