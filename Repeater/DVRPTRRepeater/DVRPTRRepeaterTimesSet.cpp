...
CDVRPTRRepeaterTimesSet::CDVRPTRRepeaterTimesSet(wxWindow* parent, int id, const wxString& title, unsigned int timeout, unsigned int ackTime) :
wxPanel(parent, id),
m_title(title),
m_timeout(NULL),
m_ackTime(NULL)
...
CDVRPTRRepeaterTimesSet::~CDVRPTRRepeaterTimesSet()
{
}

bool CDVRPTRRepeaterTimesSet::Validate()
{
	return true;
}

unsigned int CDVRPTRRepeaterTimesSet::getTimeout() const
{
	return m_timeout->GetValue();
}

unsigned int CDVRPTRRepeaterTimesSet::getAckTime() const
{
