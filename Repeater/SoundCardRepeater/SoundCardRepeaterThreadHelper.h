...
#ifndef	SoundCardRepeaterThreadHelper_H
#define	SoundCardRepeaterThreadHelper_H
...
class CSoundCardRepeaterThreadHelper : public wxThread {

public:
	CSoundCardRepeaterThreadHelper(ISoundCardRepeaterThread* thread);
	virtual ~CSoundCardRepeaterThreadHelper();
