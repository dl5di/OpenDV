...
CGMSKRepeaterTimesSet::CGMSKRepeaterTimesSet(wxWindow* parent, int id, const wxString& title, unsigned int timeout, unsigned int ackTime) :
wxPanel(parent, id),
m_title(title),
m_timeout(NULL),
m_ackTime(NULL)
...
CGMSKRepeaterTimesSet::~CGMSKRepeaterTimesSet()
{
}

bool CGMSKRepeaterTimesSet::Validate()
{
	return true;
}

unsigned int CGMSKRepeaterTimesSet::getTimeout() const
{
	return m_timeout->GetValue();
}

unsigned int CGMSKRepeaterTimesSet::getAckTime() const
{
