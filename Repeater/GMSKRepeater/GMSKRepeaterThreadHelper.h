...
#ifndef	GMSKRepeaterThreadHelper_H
#define	GMSKRepeaterThreadHelper_H
...
class CGMSKRepeaterThreadHelper : public wxThread {

public:
	CGMSKRepeaterThreadHelper(IGMSKRepeaterThread* thread);
	virtual ~CGMSKRepeaterThreadHelper();
