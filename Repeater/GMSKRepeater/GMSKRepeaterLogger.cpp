...
CGMSKRepeaterLogger::CGMSKRepeaterLogger() :
wxLog()
{
}
...
void CGMSKRepeaterLogger::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CGMSKRepeaterLogger::DoLogString(const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
