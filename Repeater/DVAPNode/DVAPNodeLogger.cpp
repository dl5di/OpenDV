...
CDVAPNodeLogger::CDVAPNodeLogger() :
wxLog()
{
}
...
void CDVAPNodeLogger::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CDVAPNodeLogger::DoLogString(const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
