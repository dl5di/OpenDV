...
#ifndef	DVAPNodeCallsignSet_H
#define	DVAPNodeCallsignSet_H
...
class CDVAPNodeCallsignSet : public wxPanel {
public:
	CDVAPNodeCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation);
	virtual ~CDVAPNodeCallsignSet();
