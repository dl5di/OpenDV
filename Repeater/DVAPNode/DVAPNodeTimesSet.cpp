...
CDVAPNodeTimesSet::CDVAPNodeTimesSet(wxWindow* parent, int id, const wxString& title, unsigned int timeout, unsigned int ackTime) :
wxPanel(parent, id),
m_title(title),
m_timeout(NULL),
m_ackTime(NULL)
...
CDVAPNodeTimesSet::~CDVAPNodeTimesSet()
{
}

bool CDVAPNodeTimesSet::Validate()
{
	return true;
}

unsigned int CDVAPNodeTimesSet::getTimeout() const
{
	return m_timeout->GetValue();
}

unsigned int CDVAPNodeTimesSet::getAckTime() const
{
