...
#ifndef	DVRPTRClientFrame_H
#define	DVRPTRClientFrame_H
...
class CDVRPTRClientFrame : public wxFrame {
public:
	CDVRPTRClientFrame(const wxString& title = wxEmptyString);
	virtual ~CDVRPTRClientFrame();
