...
CDVRPTRClientCallsignSet::CDVRPTRClientCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign1, const wxString& callsign2) :
wxPanel(parent, id),
m_title(title),
m_callsign1(NULL),
m_callsign2(NULL)
...
CDVRPTRClientCallsignSet::~CDVRPTRClientCallsignSet()
{
}

bool CDVRPTRClientCallsignSet::Validate()
{
...
wxString CDVRPTRClientCallsignSet::getCallsign1() const
{
	return m_callsign1->GetValue().MakeUpper();
}

wxString CDVRPTRClientCallsignSet::getCallsign2() const
{
