...
CDVAPClientCallsignSet::CDVAPClientCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign1, const wxString& callsign2) :
wxPanel(parent, id),
m_title(title),
m_callsign1(NULL),
m_callsign2(NULL)
...
CDVAPClientCallsignSet::~CDVAPClientCallsignSet()
{
}

bool CDVAPClientCallsignSet::Validate()
{
...
wxString CDVAPClientCallsignSet::getCallsign1() const
{
	return m_callsign1->GetValue().MakeUpper();
}

wxString CDVAPClientCallsignSet::getCallsign2() const
{
