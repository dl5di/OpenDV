...
#ifndef	SoundCardClientDefs_H
#define	SoundCardClientDefs_H
...
const wxString APPLICATION_NAME = wxT("Sound Card Client");

const wxString LOG_FILE_NAME    = wxT("SoundCardClient");
