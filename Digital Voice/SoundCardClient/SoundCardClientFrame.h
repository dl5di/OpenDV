...
#ifndef	SoundCardClientFrame_H
#define	SoundCardClientFrame_H
...
class CSoundCardClientFrame : public wxFrame {
public:
	CSoundCardClientFrame(const wxString& title = wxEmptyString);
	virtual ~CSoundCardClientFrame();
