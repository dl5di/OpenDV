...
CDCSClientCallsignSet::CDCSClientCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign) :
wxPanel(parent, id),
m_title(title),
m_callsign(NULL)
{
...
CDCSClientCallsignSet::~CDCSClientCallsignSet()
{
}

bool CDCSClientCallsignSet::Validate()
{
...
wxString CDCSClientCallsignSet::getCallsign() const
{
