...
#ifndef	DCSClientApp_H
#define	DCSClientApp_H
...
class CDCSClientApp : public wxApp {

public:
	CDCSClientApp();
	virtual ~CDCSClientApp();
	...
	virtual void getStartup(wxString& reflector) const;
	virtual void setStartup(const wxString& reflector) const;

private:
	CDCSClientFrame*  m_frame;
	CDCSClientThread* m_thread;

	void createThread();
};

DECLARE_APP(CDCSClientApp)
