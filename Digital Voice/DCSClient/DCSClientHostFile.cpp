...
CDCSClientHostFile::CDCSClientHostFile(const wxString& fileName) :
m_names(),
m_hosts()
{
...
CDCSClientHostFile::~CDCSClientHostFile()
{
}

unsigned int CDCSClientHostFile::getCount() const
{
	return m_hosts.GetCount();
}

wxString CDCSClientHostFile::getName(unsigned int n) const
{
	return m_names.Item(n);
}

wxString CDCSClientHostFile::getHost(unsigned int n) const
{
