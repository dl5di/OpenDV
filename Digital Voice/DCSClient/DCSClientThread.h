...
#ifndef	DCSClientThread_H
#define	DCSClientThread_H
...
class CDCSClientThread : public wxThread, public IAudioCallback {
public:
	CDCSClientThread();
	virtual ~CDCSClientThread();
...
private:
	...
	CDCSProtocolHandler        m_protocol;
	bool                       m_stopped;
	...
	void resetReceiver();
	void processFrame(const unsigned char* buffer, bool start, bool sync, bool end);
