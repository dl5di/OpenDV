...
CDCSClientControllerSet::CDCSClientControllerSet(wxWindow* parent, int id, const wxString& title, const wxString& type, unsigned int delay, bool pttInvert, bool squelchInvert) :
wxPanel(parent, id),
m_title(title),
m_type(NULL),
m_delay(NULL),
...
CDCSClientControllerSet::~CDCSClientControllerSet()
{
}

bool CDCSClientControllerSet::Validate()
{
...
wxString CDCSClientControllerSet::getType() const
{
...
unsigned int CDCSClientControllerSet::getDelay() const
{
...
bool CDCSClientControllerSet::getPTTInvert() const
{
...
bool CDCSClientControllerSet::getSquelchInvert() const
{
