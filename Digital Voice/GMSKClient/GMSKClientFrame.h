...
#ifndef	GMSKClientFrame_H
#define	GMSKClientFrame_H
...
class CGMSKClientFrame : public wxFrame {
public:
	CGMSKClientFrame(const wxString& title = wxEmptyString);
	virtual ~CGMSKClientFrame();
