...
#if !defined(_IRCDDBCLIENT_H)
#define _IRCDDBCLIENT_H
...
public:
	CIRCDDBClient(const wxString& hostName, unsigned int port, const wxString& callsign, const wxString& password,
