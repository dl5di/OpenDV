...
void CSlowDataEncoder::setTextData(const std::string& text)
{
	...
	m_textData[1U]  = text.at(0);
	m_textData[2U]  = text.at(1);
	m_textData[3U]  = text.at(2);
	m_textData[4U]  = text.at(3);
	m_textData[5U]  = text.at(4);

	m_textData[6U]  = SLOW_DATA_TYPE_TEXT | 1U;
	m_textData[7U]  = text.at(5);
	m_textData[8U]  = text.at(6);
	m_textData[9U]  = text.at(7);
	m_textData[10U] = text.at(8);
	m_textData[11U] = text.at(9);

	m_textData[12U] = SLOW_DATA_TYPE_TEXT | 2U;
	m_textData[13U] = text.at(10);
	m_textData[14U] = text.at(11);
	m_textData[15U] = text.at(12);
	m_textData[16U] = text.at(13);
	m_textData[17U] = text.at(14);

	m_textData[18U] = SLOW_DATA_TYPE_TEXT | 3U;
	m_textData[19U] = text.at(15);
	m_textData[20U] = text.at(16);
	m_textData[21U] = text.at(17);
	m_textData[22U] = text.at(18);
	m_textData[23U] = text.at(19);
