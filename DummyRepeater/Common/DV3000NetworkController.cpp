...
CDV3000NetworkController::CDV3000NetworkController(const wxString& address, unsigned int port) :
m_socket(address, port)
{
}

CDV3000NetworkController::~CDV3000NetworkController()
{
}

bool CDV3000NetworkController::open()
{
...
void CDV3000NetworkController::encodeIn(const wxFloat32* audio, unsigned int length)
{
	wxASSERT(audio != NULL);
...
bool CDV3000NetworkController::encodeOut(unsigned char* ambe, unsigned int length)
{
	wxASSERT(ambe != NULL);
...
void CDV3000NetworkController::decodeIn(const unsigned char* ambe, unsigned int length)
{
	wxASSERT(ambe != NULL);
	wxASSERT(length == VOICE_FRAME_LENGTH_BYTES);
...
bool CDV3000NetworkController::decodeOut(wxFloat32* audio, unsigned int length)
{
	wxASSERT(audio != NULL);
	wxASSERT(length == DSTAR_AUDIO_BLOCK_SIZE);
...
void CDV3000NetworkController::close()
{
	m_socket.close();
}

CDV3000NetworkController::RESP_TYPE CDV3000NetworkController::getResponse(unsigned char* buffer, unsigned int length)
{
